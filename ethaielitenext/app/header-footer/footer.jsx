...
const Footer = () => {
 ...
 > 
        ...
        <div className="item md:px-6 md:w-4/12">
          ...
          <Link href="/elite-superiority-extension"><h3 className='hover:text-amber-900 hover:bg-gray-300 px-4 py-2'>&#x27A4; Thailand Elite Superiority Extension Membership (20 Years Thai Elite Visa)</h3></Link>
          <Link href="/elite-family-premium"><h3 className='hover:text-amber-900 hover:bg-gray-300 px-4 py-2'>&#x27A4; Thailand Elite Family Premium Membership</h3></Link>
          <Link href="/elite-ultimate-privilege"><h3 className='hover:text-amber-900 hover:bg-gray-300 px-4 py-2'>&#x27A4; Thailand Elite Ultimate Privilege Membership (20 Years Thai Elite Visa)</h3></Link>
          ...
          <Link href="/elite-privilege-access"><h3 className='hover:text-amber-900 hover:bg-gray-300 px-4 py-2'>&#x27A4; Thailand Elite Privilege Access Membership (10 Years Thai Elite Visa)</h3></Link>
          <Link href="/elite-family-alternative"><h3 className='hover:text-amber-900 hover:bg-gray-300 px-4 py-2'>&#x27A4;Thailand Elite Family Alternative Membership (10 Years Thai Elite Visa)</h3></Link>
          <Link href="/elite-family-excersion"><h3 className='hover:text-amber-900 hover:bg-gray-300 px-4 py-2'>&#x27A4; Thailand Elite Family Excursion Membership (5 Years Thai Elite Visa)</h3></Link>
          <Link href="/elite-easy-access"><h3 className='hover:text-amber-900 hover:bg-gray-300 px-4 py-2'>&#x27A4; Thai Elite Easy Access Membership (5 Years Thailand Elite Visa)</h3></Link>
        </div>
