  ...
  return (
    ...
    <div class="section md:flex gap-20 p-10 md:pb-36 justify-center bg-slate-200 items-center">
      <div class="left md:w-8/12">
        <div class="my-6">
          <h2 class="md:text-3xl text-lg text-orange-500">ELITE FAMILY ALTERNATIVE</h2>
          <div class="w-[12%] mt-2 h-[1px] bg-black"></div>
        </div>
        <p class="md:text-justify">The Elite Family Alternative membership allows you and your family to visit Thailand
          to enjoy long vacations
          or just for
          short visits. Exclusive membership services include assistance when contacting government agencies such as the
          immigration department and the mandatory 90-day reporting procedure.</p>
      </div>
    ...
    <div class="w-[90%] md:-mt-24 mx-auto md:flex gap-6">
      ...
      <div class="item md:w-4/12 text-center p-2 bg-white rounded-md shadow-md">
        ...
        <div class="">
          ...
          <h3>THB 800,000 (VAT included)</h3>
        </div>
      </div>
      <div class="item md:w-4/12 text-center p-2 bg-white rounded-md shadow-md">
        <div class="flex justify-center items-center rounded-full mx-auto my-4 w-20 h-20 bg-slate-200">
        ...
        <div class="">
          <h2 class="font-bold">Additional family member</h2>
          <h3 class="text-sm">THB 700,000 (VAT included) per additional member. Valid for a period equal to the
    ...
    <div className="mx-10 my-20">
      ...
      <img className='px-8' src="./images/membership-packages/Elite-Family-Alternative-Membership.jpg" alt="elite family alternative membership"  />
      </div>
      <h2 className='text-3xl'>Thailand Elite Family Alternative Membership (10 Years)</h2>
      <h3 className='text-lg text-gray-700 mt-4'>Travel is a good hobby, and you should do it with your family. Holidays in Thailand are most enjoyed by the teams. Make the experience seamless, convenient and comfortable for your family with Elite Family Options membership in Thailand Elite Visa Service.</h3>
      <p className='text-lg leading-loose mt-10 text-gray-600 md:text-justify md:px-8'>Your membership will ensure that your family winds through the method of arrival at the airport. If you want to expand your position, it’s easy to manage the process because you have access to legal support throughout the process. Your personal assistant can help make the process easier for you, so you don’t have to deal with bureaucracy’s hassle.

Whether you and your family are in Thailand for a short vacation or an extended retreat, Thailand Elite visa service will ensure that your membership goes well and does not go against your plans.</p>
</div>
...
<div className="md:mx-20">
  ...
  <tr>
    ...
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>THB 800,000 (VAT included)</td>
  </tr>
  <tr className='bg-gray-50'>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-4/12 font-bold'>Additional Membership Fee</td>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>THB 700,000 each (VAT included)</td>
  </tr>
  <tr>
  ...
  <tr className='bg-gray-50'>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-4/12 font-bold'>Payment</td>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>Pay upon approval of your application.</td>
  </tr>
  <tr className='bg-gray-50'>
  ...
  <tr>
    ...
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>10 (Ten) years multiple entry visa with extendable one-year length of stay per each entry</td>
  </tr>
  <tr className='bg-gray-50'>
...
export default FamilyAlternative
