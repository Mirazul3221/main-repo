  ...
  return (
    ...
    <div class="section md:flex gap-20 p-10 md:pb-36 justify-center bg-slate-200 items-center">
      <div class="left md:w-8/12">
        <div class="my-6">
          <h2 class="text-3xl text-orange-500">ELITE EASY ACCESS</h2>
          <div class="w-[12%] mt-2 h-[1px] bg-black"></div>
        </div>
        <p class="md:text-justify">
        Thailand Elite Visa, Elite Easy Access Membership for 5 years to stay and enjoy in Thailand for long term. This Thailand Elite Visa membership package allow it’s subscriber to stay and get elite facilities for 5 years. You will be able to enjoy privileges both for business and pleasure. Apart from unlimited enjoyment and discover Thailand, individuals allowed to get amazing healthcare services. Apply today and we always ready to welcome you in the land of smile.
        </p>
      </div>
    ...
    <div class="w-[90%] md:-mt-24 mx-auto md:flex gap-6">
      ...
      <div class="item md:w-4/12 text-center p-2 bg-white rounded-md shadow-md">
        ...
        <div class="">
          ...
          <h3>THB 600,000 (VAT included)</h3>
        </div>
      </div>
      <div class="item md:w-4/12 text-center p-2 bg-white rounded-md shadow-md">
        <div class="flex justify-center items-center rounded-full mx-auto my-4 w-20 h-20 bg-slate-200">
        ...
        <div class="">
          <h2 class="font-bold">Upgrade</h2>
          <h3 class="text-sm">For an additional THB 400,000
            (including VAT).
            You can be upgraded to the Superiority Extension option</h3>
        </div>
      </div>
      <div class="item md:w-4/12 text-center p-2 bg-white rounded-md shadow-md">
        <div class="flex justify-center items-center rounded-full mx-auto my-4 w-20 h-20 bg-slate-200">
    ...
    <div className="mx-10 my-20">
      ...
      <img className='px-8' src="./images/membership-packages/Elite-Easy-Access-Membership.jpg" alt="elite easy access membership" />
      </div>
      <h2 className='text-3xl'>Thailand Elite Easy Access</h2>
      <h3 className='text-lg text-gray-700 mt-4'>It is a favorite choice for those who like to travel to Thailand often.</h3>
      <p className='text-lg leading-loose mt-10 text-gray-600 md:text-justify md:px-8'>Whether you are in Thailand for business or pleasure, it is a must to feel the pleasure of the monthly full moon party. These teams allow you and other tourists to come together and share Thailand’s offers in terms of entertainment.

In addition, improve that experience by becoming an easy access member of Elite in Thailand. It comes with a five-year, multiple entry visa that you can renew after expiration.
<br />

Say goodbye to long lines of immigration after arrival, because 

Thailand Elite easy access membership allows you access to exclusive lounges where your immigration process is faster by 90%! You also get access to luxurious limousine services, from your hotel to other destinations. The Elite Easy Access can be upgraded to Elite Superiority Extension, making your stay valid for 20 years.</p>
    </div>
  ...
  <tr className='bg-gray-50'>
    ...
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>5 Years Elite Visa</td>
  </tr>
  <tr>
