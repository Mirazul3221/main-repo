  ...
  return (
    ...
    <div class="section md:flex gap-20 p-10 md:pb-36 justify-center bg-slate-200 items-center">
      <div class="left md:w-8/12">
        <div class="my-6">
          <h2 class="text-3xl text-orange-500">ELITE PRIVILEGE ACCESS</h2>
          <div class="w-[12%] mt-2 h-[1px] bg-black"></div>
        </div>
        <p class="md:text-justify">Thailand Elite Visa, Elite Privilege Access Membership for 10 years to stay and enjoy in Thailand for long term. This Thailand Elite Visa membership package allow it’s subscriber to stay and get elite facilities for 10 years. You will be able to enjoy privileges both for business and pleasure. Apart from unlimited enjoyment and discover Thailand, individuals allowed to get amazing healthcare services. Apply today and we always ready to welcome you in the land of smile.</p>
      </div>
      <div class="right md:w-4/12">
            <img src="./images/membership-packages/Elite-Privilege-Access-Membership.jpg" alt="elite privilege access" />
      </div>
    </div>
    ...
    <div class="w-[90%] md:-mt-24 mx-auto md:flex gap-6">
      <div class="item md:w-4/12 text-center p-2 bg-white rounded-md shadow-md">
        ...
        <div class="">
          ...
          <h3>10 Years
            Valid for a period equal to the remainder term of the core member</h3>
        </div>
      </div>
      <div class="item md:w-4/12 text-center p-2 bg-white rounded-md shadow-md">
        <div class="flex justify-center items-center rounded-full mx-auto my-4 w-20 h-20 bg-slate-200">
      ...
      <div class="item md:w-4/12 text-center p-2 bg-white rounded-md shadow-md">
        ...
        <div class="">
          <h2 class="font-bold">Additional Membership Fee</h2>
          <h3 class="text-sm">THB 800,000 (VAT included)
            per additional member</h3>
        </div>
      </div>
      <div class="item md:w-4/12 text-center p-2 bg-white rounded-md shadow-md">
        <div class="flex justify-center items-center rounded-full mx-auto my-4 w-20 h-20 bg-slate-200">
    ...
    <div className="mx-10 my-20">
      ...
      <img className='px-8' src="./images/membership-packages/Elite-Privilege-Access-Membership.jpg" alt="elite privilege access membership" />
      </div>
      <h2 className='text-3xl'>Thailand Elite Privilege Access Membership</h2>
      <h3 className='text-lg text-gray-700 mt-4'>The best time to visit Thailand. Sign up now for membership with Elite Privilege access to Thailand Elite Visa.</h3>
      <p className='text-lg leading-loose mt-10 text-gray-600 md:text-justify md:px-8'>Access to Elite Privileges offers you exclusive hospitality benefits that truly personalize your experience in Thailand as you want it. Partner company Thailand Elite has special arrangements for dining and accommodation reserved for members. Go around the style and luxury of the airport from the hotel, and vice versa, the limousine transfer service.
<br />

You can get the best access that Thailand’s healthcare system can offer its visitors, if someone on tour experiences an unexpected illness.</p>
    </div>
  ...
  <tr className='bg-gray-50'>
    ...
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>10 Years Elite Visa</td>
  </tr>
  <tr>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-4/12 font-bold'>Additional Membership Validity</td>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>Valid for a period equal to the remaining term of the core member</td>
  </tr>
  <tr className='bg-gray-50'>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-4/12 font-bold'>Membership Fee</td>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>THB 600,000(VAT included)</td>
  </tr>
  <tr>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-4/12 font-bold'>Additional Membership Fee</td>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>THB 800,000 each (VAT included)</td>
  </tr>
  <tr className='bg-gray-50'>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-4/12 font-bold'>Membership Upgrade</td>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>Elite Access can be upgraded to Ultimate Privilege for THB 1.5 Million (VAT included) or Superiority Extension for THB 400,000 (VAT included).</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>5 (Five) years multiple entry visa with extendable one-year length of stay per each entry</td>
  </tr>
  <tr className='bg-gray-50'>
