  ...
  return (
    ...
    <div class="section md:flex gap-20 p-10 md:pb-36 justify-center bg-slate-200 items-center">
      <div class="left md:w-8/12">
        <div class="my-6">
          <h2 class="text-lg md:text-3xl text-orange-500">ELITE FAMILY EXCURSION</h2>
          <div class="w-[12%] mt-2 h-[1px] bg-black"></div>
        </div>
        <p class="md:text-justify">Thailand Elite Visa, Elite Family Excursion Membership for 5 years to stay and enjoy in Thailand for long term. This Thailand Elite Visa membership package allow it’s subscriber to stay and get elite facilities for 5 years. You will be able to enjoy privileges both for business and pleasure. Apart from unlimited enjoyment and discover Thailand, individuals allowed to get amazing healthcare services. Apply today and we always ready to welcome you in the land of smile.</p>
      </div>
    ...
    <div class="w-[90%] md:-mt-24 mx-auto md:flex gap-6">
      ...
      <div class="item md:w-4/12 text-center p-2 bg-white rounded-md shadow-md">
        ...
        <div class="">
          ...
          <h3 class="text-sm">THB 300,000</h3>
        </div>
      </div>
    </div>
...
export default FamilyExcersion
