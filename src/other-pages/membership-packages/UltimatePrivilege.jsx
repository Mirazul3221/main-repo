  ...
  return (
    <div>
      ...
      <div class="left md:w-8/12">
        <div class="my-6">
          <h2 class="text-3xl text-orange-500">ELITE ULTIMATE PRIVILEGE</h2>
          <div class="w-[12%] mt-2 h-[1px] bg-black"></div>
        </div>
        <p class="md:text-justify">Thailand Elite Visa, Elite Ultimate Privilege Membership for 20 years to stay and enjoy in Thailand for long term. This Thailand Elite Visa membership package allow it’s subscriber to stay and get elite facilities for 20 years. You will be able to enjoy privileges both for business and pleasure. Apart from unlimited enjoyment and discover Thailand, individuals allowed to get amazing healthcare services. Apply today and we always ready to welcome you in the land of smile.</p>
      </div>
      <div class="right md:w-4/12">
            <img src="./images/membership-packages/Elite-Ultimate-Privilege-Membership.jpg" alt="elite ultimate privilege" />
      </div>
    </div>
    ...
    <div class="w-[90%] md:-mt-24 mx-auto md:flex gap-6">
      ...
      <div class="item md:w-4/12 text-center p-2 bg-white rounded-md shadow-md">
        ...
        <div class="">
          <h2 class="font-bold">Transfer fee</h2>
          <h3 class="text-sm">20% of prevailing rate</h3>
        </div>
      </div>
      <div class="item md:w-4/12 text-center p-2 bg-white rounded-md shadow-md">
        <div class="flex justify-center items-center rounded-full mx-auto my-4 w-20 h-20 bg-slate-200">
    ...
    <div className="mx-10 my-20">
      ...
      <img className='px-8' src="./images/membership-packages/Elite-Ultimate-Privilege-Membership.jpg" alt="elite ultimate privilege membership" />
      </div>
      <h2 className='text-3xl'>Thailand Elite Ultimate Privilege Membership</h2>
      <h3 className='text-lg text-gray-700 mt-4'>Elite package for leisure and traders who want to enjoy all the benefits and benefits of Thailand Elite Visa for 20 years.</h3>
      <p className='text-lg leading-loose mt-10 text-gray-600 md:text-justify md:px-8'>There are many benefits to doing business in Thailand or even to retire in Thailand. The Kingdom is a very investor-friendly country, with several free trade agreements with different countries that make it helpful to do business. When you are thinking of retiring to Thailand, you can be sure that you have investment opportunities from which you can earn some money to support yourself.
      <br />

As a businessman, you are often expected to visit Thailand for business purposes. As an entrepreneur, your time is money. For example, you don’t have to go through immigration issues at the time of arrival. With your Thailand Elite membership, you can wind through immigration and be on your way to your hotel and your business meetings.
<br />
With Thailand Elite Ultimate Privilege membership, doing business in Thailand is really a seamless and hassle-free experience. For inquiries, contact or open live chat for more information.</p>
    </div>
  ...
  <tr>
    ...
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>THB 2000,000</td>
  </tr>
  <tr className='bg-gray-50'>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-4/12 font-bold'>Transfer Fee</td>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>20% of Prevailing Rate*</td>
  </tr>
  <tr>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-4/12 font-bold'>Annual Fee</td>
    <td  className='border-[1px] md:px-10 px-4 py-2 text-left w-8/12'>THB 20,000*</td>
  </tr>
  <tr className='bg-gray-50'>
...
export default UltimatePrivilege
